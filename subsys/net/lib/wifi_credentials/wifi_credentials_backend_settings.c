...
#define WIFI_CREDENTIALS_SBE_KEY_SIZE sizeof(WIFI_CREDENTIALS_SBE_BASE_KEY "/" \
					     STRINGIFY(CONFIG_WIFI_CREDENTIALS_MAX_ENTRIES))
...
int wifi_credentials_backend_init(void)
{
	...
	LOG_ERR("Key size is %d", WIFI_CREDENTIALS_SBE_KEY_SIZE);
