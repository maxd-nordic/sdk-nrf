...
if(SB_CONFIG_BOARD_THINGY91X_NRF5340_CPUAPP OR SB_CONFIG_BOARD_THINGY91X_NRF5340_CPUAPP_NS)
  if(SB_CONFIG_THINGY91X_NO_PREDEFINED_LAYOUT)
  endif()
  if(SB_CONFIG_THINGY91X_STATIC_PARTITIONS_NRF53_SINGLE_SLOT)
    set(PM_STATIC_YML_FILE ${CMAKE_CURRENT_LIST_DIR}/thingy91x_nrf5340_pm_static_single.yml CACHE INTERNAL "")
  endif()
