...
#if (defined(CONFIG_BOARD_THINGY91_NRF9160_NS) || defined(CONFIG_BOARD_THINGY91V2_NRF9161_NS)) && defined(CONFIG_UI_LED_USE_PWM)
#define APP_TYPE	"RGB PWM LED controller"
#elif defined(CONFIG_BOARD_THINGY91_NRF9160_NS) || defined(CONFIG_BOARD_THINGY91V2_NRF9161_NS)
