...
enum location_module_event_type {
	 ...
	 *  The event has associated payload of type @ref location_module_wifi_access_points in
	 *  the ``data.wifi_scan_info`` member.
	 */
...
/** @brief Location module data for associated payload for event of
 *         LOCATION_MODULE_EVT_WIFI_ACCESS_POINTS_DATA_READY types.
 */
